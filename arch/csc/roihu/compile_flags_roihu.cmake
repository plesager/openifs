...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
  ...
  set(IFS_C_FLAGS_BIT "-g -fpermissive  ${IFS_GNU64_FLAG}")
  set(IFS_C_FLAGS_DEBUG "-g -O0 -fpermissive ${IFS_GNU64_FLAG}")
#  set(IFS_C_FLAGS_BIT "-g -fpermissive -std=c17 ${IFS_GNU64_FLAG}")
#  set(IFS_C_FLAGS_DEBUG "-g -fpermissive -std=c17 -O0 ${IFS_GNU64_FLAG}")

  if( CMAKE_CXX_COMPILER_ID MATCHES "GNU" )
    set(IFS_CXX_FLAGS_BIT "-g -O1 -std=c++17 ${IFS_GNU64_FLAG}")
    set(IFS_CXX_FLAGS_DEBUG "-g -O0 -std=c++17 ${IFS_GNU64_FLAG}")
  endif()
