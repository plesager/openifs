...
!end DO
  !write(*,*)'line1',KIDIA  , KFDIA , KLON , KTDIA, KLEV , KTILES, NSTART, NSTEP , KSTGLO
  !write(*,*)'line2',KSW    , KTRAC , KAERO
  !write(*,*)'line3',PALB   , PALBD , PAPHI
  !write(*,*)'line4',PAERDEP,PAERLTS, PAERSCC, PAERGUST, ZALT
  !write(*,*)'line5',PBCBF  , PBCFF , PBCGF, POMBF, POMFF, POMGF
  !write(*,*)'line6',PRS1   , PRSF1 , PCI  , PCLAKE, PINJF, PBLH, ZDP, PGELAM, PGELAT, PGEMU, PFRTI, PHSDFOR
  !write(*,*)'line7',PLSM   , PSST  , PQP   , ZRHO , PSNS , PTP  , PTL  , PTSPHY, PZ0M, KCHEM
  !write(*,*)'line8',ZWND   , PWSA1 , PSOIL_TYPE
  !write(*,*)'line9',PCVL  , PCVH, KTVL, KTVH
  !write(*,*)'line10',PLDAY  , PAERFLX, PCFLX, PCEN , PTENC, ZEMIDIAG, PSO2SRC,PSO4SRC,PSOA,PSOACO
  CALL TM5M7_SRC &
