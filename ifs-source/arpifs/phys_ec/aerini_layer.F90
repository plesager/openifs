...
!VH        &  PSURF%PSD_VF(:,YSD_VF%YBCBF%MP), PSURF%PSD_VF(:,YSD_VF%YBCFF%MP), PSURF%PSD_VF(:,YSD_VF%YBCGF%MP),&
!VH        &  PSURF%PSD_VF(:,YSD_VF%YOMBF%MP), PSURF%PSD_VF(:,YSD_VF%YOMFF%MP), PSURF%PSD_VF(:,YSD_VF%YOMGF%MP),&
!VH        &  PSURF%PSD_VF(:,YSD_VF%YSO2L%MP), PSURF%PSD_VF(:,YSD_VF%YSO2H%MP), PSURF%PSD_VF(:,YSD_VF%YSO2DD%MP),&
!VH        &  PSURF%PSD_VF(:,YSD_VF%YSOGF%MP),&
!VH        &  PSURF%PSD_VF(:,YSD_VF%YVOLC%MP), PSURF%PSD_VF(:,YSD_VF%YVOLE%MP), PSURF%PSD_VF(:,YSD_VF%YSOA%MP) ,&
!VH        &  PSURF%PSD_VF(:,YSD_VF%YSOACO%MP),PSURF%PSD_VF(:,YSD_VF%YDMSO%MP), PSURF%PSD_VF(:,YSD_VF%YSOILTYPE%MP), &
...
!VH        &  GEMSL%ZDMSI, GEMSL%ZODMS, PSURF%PSD_XA, &
!VH        &PSO4SRC,PSO2SRC)
