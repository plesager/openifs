...
IF(.not. LAERCHEM)THEN
   call simple_sulfur_src(YDGEOMETRY, KDIM%KIDIA, KDIM%KFDIA, KDIM%KLON , KDIM%KTDIA, KDIM%KLEV,& 
...
SELECT CASE (TRIM(AERO_SCHEME))
  ...
  CASE ("tm5m7", "hamm7")
    ...
    CALL TM5M7_PHY2 &
        ...
        &  GEMSL%ZAERWS, GEMSL%ZAERGUST, GEMSL%ZAERUST,&
        &  PSURF%PSD_VF(:,YSD_VF%YBCBF%MP), PSURF%PSD_VF(:,YSD_VF%YBCFF%MP), PSURF%PSD_VF(:,YSD_VF%YBCGF%MP),&
        &  PSURF%PSD_VF(:,YSD_VF%YOMBF%MP), PSURF%PSD_VF(:,YSD_VF%YOMFF%MP), PSURF%PSD_VF(:,YSD_VF%YOMGF%MP),&
        &  PSURF%PSD_VF(:,YSD_VF%YSO2L%MP), PSURF%PSD_VF(:,YSD_VF%YSO2H%MP), PSURF%PSD_VF(:,YSD_VF%YSO2DD%MP),&
        &  PSURF%PSD_VF(:,YSD_VF%YSOGF%MP),&
        &  PSURF%PSD_VF(:,YSD_VF%YVOLC%MP), PSURF%PSD_VF(:,YSD_VF%YVOLE%MP), PSURF%PSD_VF(:,YSD_VF%YSOA%MP) ,&
        &  PSURF%PSD_VF(:,YSD_VF%YSOACO%MP),PSURF%PSD_VF(:,YSD_VF%YDMSO%MP), PSURF%PSD_VF(:,YSD_VF%YSOILTYPE%MP), &
        !TB added lake cover: YCLK
        &  PSURF%PSD_VF(:,YSD_VF%YCI%MP), PSURF%PSD_VF(:,YSD_VF%YCLK%MP) , PSURF%PSD_VF(:,YSD_VF%YINJF%MP) , PSURF%PSD_VD(:,YSD_VD%YBLH%MP) ,&
        &  SURFL%ZFRTI, PSURF%PSD_VF(:,YSD_VF%YLSM%MP) , PSURF%PSD_VF(:,YSD_VF%YSST%MP), STATE%Q, & 
        &  PSURF%PSP_SG(:,YSP_SG%YF%MP9) , PSURF%PSP_RR(:,YSP_RR%YT%MP9)  , PAUX%PGELAM, PAUX%PGELAT, PAUX%PGEMU, SURFL%ZHSDFOR,&
