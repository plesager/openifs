...
DO JL=KDIM%KIDIA,KDIM%KFDIA
  !write(*,*) "JL", JL
  !write(*,*) "PRAD%PEMTC(JL,1)",PRAD%PEMTC(JL,1)
  !write(*,*) "PRAD%PEMTC(JL,KDIM%KLEV+1)",PRAD%PEMTC(JL,KDIM%KLEV+1)
  !write(*,*) "AUXL%ZCEMTR(JL,0)",AUXL%ZCEMTR(JL,0)
  !write(*,*) "AUXL%ZCEMTR(JL,1)",AUXL%ZCEMTR(JL,1)
