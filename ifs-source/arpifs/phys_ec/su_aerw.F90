...
!              -------------------
  ...
  WRITE(UNIT=NULOUT,FMT='('' LAERGBUD = '',L1 &
   ...
   & ,'' LAERRAD= '',L1&
   & )')&
   & LAERGBUD,LAERNGAT,LAERDRYDP,LAERSEDIM,LAERSEDIMSS,LAERGTOP,LAERHYGRO,NAERSCAV,NAERACT,LAERCHEM,LAERNITRATE,LAERSOA,LAERSOA_COUPLED, &
