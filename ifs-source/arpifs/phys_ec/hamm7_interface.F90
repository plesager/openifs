...
ASSOCIATE(YGFL=>YDMODEL%YRML_GCONF%YGFL, YREAERSRC=>YDMODEL%YRML_PHY_AER%YREAERSRC,YREAERATM=>YDMODEL%YRML_PHY_RAD%YREAERATM, &
 ...
 & NACTAERO=>YDMODEL%YRML_GCONF%YGFL%NACTAERO, NAERO=>YDMODEL%YRML_GCONF%YGFL%NAERO, NGHG=>YDMODEL%YRML_GCONF%YGFL%NGHG, NCHEM=>YDMODEL%YRML_GCONF%YGFL%NCHEM, ZTRAC=>YDMODEL%YRML_GCONF%YGFL%NTRAC, NSO4SCHEME => YDMODEL%YRML_PHY_AER%YREAERSRC%NSO4SCHEME, &
 & NDIM=>YDMODEL%YRML_GCONF%YGFL%NDIM, YAEROUT=>YDMODEL%YRML_GCONF%YGFL%YAEROUT, YR=>YDMODEL%YRML_GCONF%YGFL%YR, YS=>YDMODEL%YRML_GCONF%YGFL%YS, &
 & LCHEM_DIA=>YDMODEL%YRML_CHEM%YRCOMPO%LCHEM_DIA, YCHEM=>YDMODEL%YRML_GCONF%YGFL%YCHEM, YAERO=>YDMODEL%YRML_GCONF%YGFL%YAERO, YGHG=>YDMODEL%YRML_GCONF%YGFL%YGHG, YTRAC=>YDMODEL%YRML_GCONF%YGFL%YTRAC, &
