...
STRATAOD(:,:,:)=0.0_JPRB
STRATAAOD(:,:,:)=0.0_JPRB  
STRATREFAOD(:,:,:)=0.0_JPRB
STRATAAOD_LW(:,:,:)=0.0_JPRB
...
RVOLCDEC=1
STRATAOD(:,:,:)=RVOLCDEC*(ZW1*STRATAOD_M(:,:,:,IMP1)+ZW2*STRATAOD_M(:,:,:,IMP2))
STRATAAOD(:,:,:)=RVOLCDEC*(ZW1*STRATAAOD_M(:,:,:,IMP1)+ZW2*STRATAAOD_M(:,:,:,IMP2))
STRATREFAOD(:,:,:)=RVOLCDEC*(ZW1*STRATREFAOD_M(:,:,:,IMP1)+ZW2*STRATREFAOD_M(:,:,:,IMP2))
STRATAAOD_LW(:,:,:)=RVOLCDEC*(ZW1*STRATAAOD_LW_M(:,:,:,IMP1)+ZW2*STRATAAOD_LW_M(:,:,:,IMP2))
!STRATAOD(:,:,:)=(ZW1*STRATAOD_M(:,:,:,IMP1)+ZW2*STRATAOD_M(:,:,:,IMP2))
!STRATAAOD(:,:,:)=(ZW1*STRATAAOD_M(:,:,:,IMP1)+ZW2*STRATAAOD_M(:,:,:,IMP2))
!STRATREFAOD(:,:,:)=(ZW1*STRATREFAOD_M(:,:,:,IMP1)+ZW2*STRATREFAOD_M(:,:,:,IMP2))
!STRATAAOD_LW(:,:,:)=(ZW1*STRATAAOD_LW_M(:,:,:,IMP1)+ZW2*STRATAAOD_LW_M(:,:,:,IMP2))
