...
SUBROUTINE TM5_MACC_AEROSOL (YREAERSNK,YREAERVOL,YREAERATM, KIDIA,KFDIA,KLON,KLEV, KACTAERO, &
    &   PAPH   , PAEROK  , PRHCL   ,   &
...
USE YOEAERSNK ,ONLY : TEAERSNK!YREAERSNK
USE YOEAERVOL ,ONLY : TEAERVOL!YREAERVOL
...
TYPE(TEAERSNK),    INTENT(INOUT) :: YREAERSNK
TYPE(TEAERVOL),    INTENT(INOUT) :: YREAERVOL
TYPE(TEAERATM),    INTENT(INOUT) :: YREAERATM
