...
IF(.NOT.LIFSMIN  .AND. .NOT.LIFSTRAJ) THEN
  ...
  DO JK=1,KLEV 
    PGFL(KIDIA:KFDIA,2,YAEROUT(1)%MP)=  PAER_SSA(KIDIA:KFDIA,JK,10)   !PAER_TAU(KIDIA:KFDIA,1:KLEV,10) !533nm
    PGFL(KIDIA:KFDIA,3,YAEROUT(1)%MP)=  PAER_ASYM(KIDIA:KFDIA,JK,10)  !PAER_TAU(KIDIA:KFDIA,1:KLEV,10) !533nm
  END DO
