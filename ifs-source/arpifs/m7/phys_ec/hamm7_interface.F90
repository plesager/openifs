...
IF(.NOT.LIFSMIN  .AND. .NOT.LIFSTRAJ) THEN
  ...
  PGFL(KIDIA:KFDIA,NACTAERO+4,YAEROUT(5)%MP)  = ((PGEOH(KIDIA:KFDIA,KLEV)-PGEOH(KIDIA:KFDIA,KLEV))*ZRG)
  PGFL(KIDIA:KFDIA,NACTAERO+5,YAEROUT(5)%MP)  = ((PGEOH(KIDIA:KFDIA,KLEV-1)-PGEOH(KIDIA:KFDIA,KLEV))*ZRG)
  PGFL(KIDIA:KFDIA,NACTAERO+6,YAEROUT(5)%MP)  = ((PGEOH(KIDIA:KFDIA,KLEV-2)-PGEOH(KIDIA:KFDIA,KLEV))*ZRG)
