...
!-- debug
  ...
  !A.Laakso:
  IF (NSTEP == YDRIP%NSTART) THEN
     DO JAERO=1,YRERAD%NTSW
     IAE=(JAERO-1)*KLEV
     ZRGP(1:IL,IHAMAEROAOD+IAE:IHAMAEROAOD+IAE+KLEV-1,IB) =0._JPRB
  ...
  ELSE
    ...
    IAE=(JAERO-1)*KLEV 
    ZRGP(1:IL,IHAMAEROAOD+IAE:IHAMAEROAOD+IAE+KLEV-1,IB) =MAX(0._JPRB, PAEROTAU(IBEG:IEND,1:KLEV,JAERO))
