...
REAL(KIND=JPRB),   INTENT(IN) :: PAEROM7_TAU(KLON,KLEV,14)
REAL(KIND=JPRB),   INTENT(IN) :: PAEROM7_SSA(KLON,KLEV,14)
REAL(KIND=JPRB),   INTENT(IN) :: PAEROM7_ASYM(KLON,KLEV,14)
...
REAL(KIND=JPRB),  INTENT(IN) :: PRE_LIQ(KLON,KLEV)
