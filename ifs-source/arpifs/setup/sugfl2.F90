...
!      1.2  Grid-point GFL.
  ...
  IF (YCDNC_NL%LGP) THEN
    ...
    CALL DEFINE_GFL_COMP(YDCOMP=YGFL%YCDNC,CDNAME=YCDNC_NL%CNAME,&
...
!       & LDERS=.FALSE.,LD5=.FALSE.,LDT1=LLT1,LDDIFF=.FALSE.,LDCONV=.FALSE., &
  ...
  IF (YICNC_NL%LGP) THEN
    ...
    CALL DEFINE_GFL_COMP(YDCOMP=YGFL%YICNC,CDNAME=YICNC_NL%CNAME,&
...
!       & LDERS=.FALSE.,LD5=.FALSE.,LDT1=LLT1,LDDIFF=.FALSE.,LDCONV=.FALSE., &
  ...
  IF (YRE_LIQ_NL%LGP) THEN
    ...
    CALL DEFINE_GFL_COMP(YDCOMP=YGFL%YRE_LIQ,CDNAME=YRE_LIQ_NL%CNAME,&
...
!       & LDERS=.FALSE.,LD5=.FALSE.,LDT1=LLT1,LDDIFF=.FALSE.,LDCONV=.FALSE., &
  ...
  IF (YRE_ICE_NL%LGP) THEN
    ...
    CALL DEFINE_GFL_COMP(YDCOMP=YGFL%YRE_ICE,CDNAME=YRE_ICE_NL%CNAME,&
