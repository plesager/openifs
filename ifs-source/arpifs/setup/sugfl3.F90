...
IF (YCDNC%LACTIVE) THEN
  CALL SET_GFL_ATTR(YDDIMV, YCDNC, LDADV=.FALSE., LDT9=.FALSE., LDPHY=.FALSE.) 
END IF
IF (YICNC%LACTIVE) THEN
  CALL SET_GFL_ATTR(YDDIMV, YICNC, LDADV=.FALSE., LDT9=.FALSE., LDPHY=.FALSE.) 
END IF
IF (YRE_LIQ%LACTIVE) THEN
  CALL SET_GFL_ATTR(YDDIMV, YRE_LIQ, LDADV=.FALSE., LDT9=.FALSE., LDPHY=.FALSE.) 
END IF
IF (YRE_ICE%LACTIVE) THEN
  CALL SET_GFL_ATTR(YDDIMV, YRE_ICE, LDADV=.FALSE., LDT9=.FALSE., LDPHY=.FALSE.) 
END IF
